 ...
 */
class modAdrOdt extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->description = "Add delivery Address fields when generate document with odt template";
	...
	function init($options='')
	{
		...
		//$result=$this->_load_tables('/adrodt/sql/');
